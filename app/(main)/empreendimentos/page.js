            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {canCreate && (
                    <Link
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-4 py-2 rounded-md shadow-sm flex items-center gap-2 transition-colors w-full sm:w-auto justify-center"
                    >
                        <FontAwesomeIcon icon={faBuilding} /> Novo Empreendimento
                    </Link>
                )}
            </div>
