...
CREATE TABLE public.ai_planning_sessions (
  ...
  CONSTRAINT ai_planning_sessions_organizacao_id_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id),
  CONSTRAINT ai_planning_sessions_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.bim_notas (
  ...
  CONSTRAINT bim_notas_pkey PRIMARY KEY (id),
  CONSTRAINT bim_notas_org_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id),
  CONSTRAINT bim_notas_proj_fkey FOREIGN KEY (projeto_bim_id) REFERENCES public.projetos_bim(id),
  CONSTRAINT bim_notas_atv_fkey FOREIGN KEY (atividade_id) REFERENCES public.activities(id),
  CONSTRAINT bim_notas_resp_fkey FOREIGN KEY (responsavel_id) REFERENCES auth.users(id),
  CONSTRAINT bim_notas_usuario_fkey FOREIGN KEY (criado_por) REFERENCES public.usuarios(id)
);
CREATE TABLE public.bim_notas_comentarios (
  ...
  criado_em timestamp with time zone DEFAULT now(),
  organizacao_id bigint,
  CONSTRAINT bim_notas_comentarios_pkey PRIMARY KEY (id),
  CONSTRAINT fk_bim_comentarios_org FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id),
  CONSTRAINT bim_notas_nota_fkey FOREIGN KEY (nota_id) REFERENCES public.bim_notas(id),
  CONSTRAINT bim_comentarios_user_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id)
);
CREATE TABLE public.bim_notas_elementos (
  ...
  external_id text NOT NULL,
  criado_em timestamp with time zone DEFAULT now(),
  CONSTRAINT bim_notas_elementos_pkey PRIMARY KEY (id),
  CONSTRAINT bim_notas_elementos_nota_fkey FOREIGN KEY (nota_id) REFERENCES public.bim_notas(id),
  CONSTRAINT bim_notas_elementos_proj_fkey FOREIGN KEY (projeto_bim_id) REFERENCES public.projetos_bim(id),
  CONSTRAINT bim_notas_elementos_org_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.chat_messages (
  ...
  CONSTRAINT fk_chat_msgs_org FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.configuracoes_ia (
  ...
  CONSTRAINT fk_config_ia_org FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.empreendimento_documento_embeddings (
  ...
  CONSTRAINT fk_embeddings_org FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.integracoes_google (
  ...
  CONSTRAINT integracoes_google_organizacao_id_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.meta_form_config (
  ...
  created_at timestamp with time zone DEFAULT now(),
  campo_destino text,
  CONSTRAINT meta_form_config_pkey PRIMARY KEY (id),
  CONSTRAINT meta_form_config_organizacao_id_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
CREATE TABLE public.meta_forms_catalog (
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT meta_forms_catalog_pkey PRIMARY KEY (id),
  CONSTRAINT meta_forms_catalog_organizacao_id_fkey FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id)
);
...
CREATE TABLE public.whatsapp_list_members (
  ...
  CONSTRAINT fk_whats_members_org FOREIGN KEY (organizacao_id) REFERENCES public.organizacoes(id),
