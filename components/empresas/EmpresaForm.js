        ...
        <div className="bg-white rounded-lg shadow p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    <button type="button" onClick={() => router.push('/empresas')} className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-50 font-bold text-sm transition-colors">Cancelar</button>
                    <button type="submit" disabled={isSaving} className="bg-blue-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-blue-700 font-bold text-sm disabled:bg-gray-300 flex items-center gap-2 transition-colors">
