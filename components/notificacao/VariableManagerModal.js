    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-gray-900/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100/50 flex flex-col max-h-[90vh] sm:max-h-[85vh] animate-in zoom-in-95 duration-200">
                ...
                {/* HEADER */}
                <div className="bg-gradient-to-br from-purple-700 via-purple-600 to-indigo-600 p-6 flex justify-between items-center text-white shrink-0 relative overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto custom-scrollbar flex-grow">
                    ...
                    {activeTab === 'create' && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="space-y-6 relative before:absolute before:left-5 before:top-2 before:bottom-2 before:w-0.5 before:bg-gradient-to-b before:from-purple-200 before:via-gray-200 before:to-transparent pl-12">
                                {/* PASSO 1: ORIGEM */}
                                ...
                                {/* PASSO 2: DESTINO */}
                                <div className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-3xl border border-gray-200 shadow-sm relative mt-2">
